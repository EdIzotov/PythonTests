...
class TestClass:
    def test_something(self):
        ...
        create_button.click()
        name = driver.find_element(By.CSS_SELECTOR, 'div.main-content input#icon_prefix')
        name.clear()
        name.send_keys('VASYAAAAA')
        phone = driver.find_element(By.CSS_SELECTOR, 'div.main-content input#icon_telephone')
        phone.clear()
